...
static Window *prv_init(void) {
  ...
  option_menu_set_status_colors(&data->option_menu, shell_prefs_get_screen_background_color(true), shell_prefs_get_screen_foreground_color(true));
  option_menu_set_highlight_colors(&data->option_menu, shell_prefs_get_highlight_color(true), shell_prefs_get_highlight_foreground_color(true));
